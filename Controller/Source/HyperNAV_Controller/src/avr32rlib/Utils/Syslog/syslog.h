...
// System log outputs
typedef enum {SYSOUT_TLM, SYSOUT_JTAG, SYSOUT_FILE} syslogOut_t;

// Verbosity settings
typedef enum {SYSLOG_ERROR=0 /* DO NOT CHANGE! */, SYSLOG_WARNING, SYSLOG_NOTICE, SYSLOG_INFO, SYSLOG_DEBUG} syslogVerbosity_t;
