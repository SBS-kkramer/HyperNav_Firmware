...
/* @(#) $Id: //Firmware/Radiometers/Hyperspectral/Source/HyperNAV/Controller/Source/HyperNAV_Controller/src/avr32rlib/Utils/zlib-1.2.8/deflate.c#2 $ */
...
{
char msg[32]; snprintf ( msg, 31, "ZLIB alloc %d\r\n", sizeof(deflate_state) );
