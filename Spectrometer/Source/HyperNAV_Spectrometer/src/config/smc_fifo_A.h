...
#ifndef SMC_FIFO_A_H_
#define SMC_FIFO_A_H_

# include <smc.h>

//! Pointer to ADC or FIFO.
#if (MCU_BOARD_REV==REV_A)
typedef U16* adc_pointer2;
#define EXT_ADC             ((adc_pointer2)AVR32_EBI_CS2_ADDRESS)
#else 
#define FIFO_DATA_A			((U16*)AVR32_EBI_CS2_ADDRESS)
#endif
