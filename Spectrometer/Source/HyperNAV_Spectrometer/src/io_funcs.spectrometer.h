...
//S16 io_print_X64 ( char* format, U64 value );
//S16 io_print_X32 ( char* format, U32 value );
//S16 io_print_X8  ( char* format, U8  value );
...
void tracepoints_clear();
void tracepoint_add (U16);
void tracepoints_show();
# endif
