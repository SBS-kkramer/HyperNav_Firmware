/*! \file profile_packet.spectrometer.h
 *
 *  \brief Define function prototypes for profile packets
 *         used on the spectrometer board.
 *
 *  @author BP, Satlantic
 *  @date   2016-01-29
 *
...
# ifndef _PROFILE_PACKET_SPECTROMETER_H_
# define _PROFILE_PACKET_SPECTROMETER_H_
...
# endif // _PROFILE_PACKET_SPECTROMETER_H_
